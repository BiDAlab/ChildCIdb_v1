...
* ### <a name="test0">Test 0: Emotional State Self-Assessment (10 seconds max.)</a>
...
* ### <a name="test1">Test 1: Tap and Reaction Time (30 seconds max.)</a>
...
* ### <a name="test2">Test 2: Drag and Drop (30 seconds max.)</a>
...
* ### <a name="test34">Test 3 and 4: Zoom-in and Zoom-out (30 seconds max. each)</a>
...
* ### <a name="test5">Test 5: Spiral Test (30 seconds max.)</a>
...
* ### <a name="test6">Test 6: Drawing Test (2 minutes max.)</a>
