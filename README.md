...
**Regarding gender, 50% of the children were male/female whereas, for the handedness, 84% were right-handed**. In addition, other information considered has been: ***i)* the previous experience of the children with mobile devices, *ii)* the children’s grades at the school, and *iii)* information regarding the attention-deficit/hyperactivity disorder (ADHD).**<br/><br/>
...
All these articles are publicly available in the [publications](https://bidalab.eps.uam.es/listpublications) section of the BiDA group webpage. Please remember to reference the above articles on any work made public, whatever the form, based directly or indirectly on any part of the ChildCIdb_v1 database.
